...
\end{align}
%
which can be expressed as a delta composition $\D_{ik}=\D_{ij}\oplus\delta_{jk}$ using \eqRef{equ:g_composition}, and defining the new delta $\delta_{jk}$ from the body magnitudes at time $t_j$,
%
...
%
The involved operations are the delta creation \eqRef{equ:delta_creation} whose Jacobians are mostly obteined by simple inspection,
%
\begin{align*}
