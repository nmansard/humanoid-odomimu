...
\draw [->, very thick, green!70] (cos_ori) -- (cos_x);
\draw [->, very thick, green!70] (cos_ori) -- (cos_y);
\draw [->, very thick, green!70] (cos_ori) -- (cos_z);

\node[draw=none,text=green!70, above left]  at (cos_ori) {$\mathcal W_{IMU}$};
