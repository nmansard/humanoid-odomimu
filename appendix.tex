...
The function $f(\sQ,\sR) = \bfq\ot\bfr = \bfQ\,\bfR$ produces rotation composition. Its Jacobians are computed from \eqRef{equ:derivative_SO3}, using the property $\Exp(\bth)\bfR=\bfR\Exp(\bfR\tr\bth)$,
%
\begin{align*}
