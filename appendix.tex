...
The function $f(\sR,\sS) = \bfp\ot\bfq = \bfR\,\bfS$ produces rotation composition. Its Jacobians are computed from \eqRef{equ:derivative_SO3}, using the property $\Exp(\bth)\bfR=\bfR\Exp(\bfR\tr\bth)$,
%
\begin{align*}
\dpar{\bfp(\bftheta)\ot\bfq}{\bftheta} 
=
\dpar{\bfR(\bftheta)\,\bfS}{\bftheta} 
...
%%
%\begin{align*}
\dpar{\bfp\ot\bfq(\bfphi)}{\bfphi} 
=
\dpar{\bfR\,\bfS(\bfphi)}{\bfphi} 
