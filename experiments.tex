...
This specific case is a common use of IMUs in fusion strategies to reduce the drift error due to IMU's biases. With a better estimation of its biases, the IMU can then be used to detect events related the human wearing the device.
