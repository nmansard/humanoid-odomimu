...
Our system is able to estimate the state of the system to a precision close to the state-of-the-art 9-state Kalman filter as shown in \figRef{fig:straight_walk} and \figRef{fig:8shape_walk}.
