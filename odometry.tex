...
These relate foot position and orientation between consecutive steps to the robot's kinematic chain derived from its joint encoders,
%
\begin{align}
...
These factors are by far the most complex in the graph, and are described in detail in the next section.
