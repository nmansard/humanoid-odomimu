...
These relate position and orientation between consecutive steps as it can be given from other sensors than IMU or methods using human walk specificities,
%
\begin{align}
